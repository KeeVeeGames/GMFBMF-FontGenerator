/// Original Author: YellowAfterlife (https://yal.cc/gamemaker-beautifying-json/) 2018, modified by me for GMS 2.3+ in 2021

global.g_json_beautify_fb = buffer_create(1024, buffer_fast, 1);
global.g_json_beautify_rb = buffer_create(1024, buffer_grow, 1);

function json_beautify(json_string/*:string*/) {
